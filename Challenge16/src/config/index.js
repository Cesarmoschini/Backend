...
export default {
  ...
  GMAIL_EMAIL: process.env.GMAIL_EMAIL || 'cesar_moschini@hotmail.com',
  ...
  TWILIO_WSP_CELLPHONE: process.env.TWILIO_WSP_CELLPHONE || '+543364327076',
  ADMIN_PHONE: process.env.ADMIN_PHONE || '+5493364327595',
};
